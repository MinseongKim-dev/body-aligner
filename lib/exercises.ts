...
export const EXERCISES: Record<string, Exercise> = {
  ...
  prone_hip_extension: {
    ...
    nameKr: '엎드려 둔근 수축 홀드',
    nameEn: 'Prone Hip Extension Hold',
    targetMuscles: ['대둔근'],
    difficulty: 'beginner',
    equipment: ['맨몸'],
    purpose: 'activation',
    phase: 1,
    patternIds: ['glute_amnesia', 'compensatory_calf_overload'],
    howTo: '엎드려 무릎을 90도 굽힌 상태에서 한쪽 발을 천장 방향으로 5cm 들어올리며 엉덩이를 의도적으로 수축합니다. 5초 홀드 후 내립니다. 수축 느낌이 없으면 먼저 손으로 엉덩이를 짚어 감각을 확인하세요.',
    prescription: { sets: 3, reps: 12, durationSec: 5, restSec: 30, eachSide: true, note: '엉덩이 "조여지는 느낌"이 없다면 반복 전 손으로 확인 후 진행' },
    demoSearchQuery: '엎드려 둔근 수축 힙익스텐션 활성화',
  },
  couch_stretch: {
    id: 'couch_stretch',
    nameKr: '코치 스트레칭 (고관절 굴곡근)',
    nameEn: 'Couch Stretch',
    targetMuscles: ['장요근', '대퇴직근', '장골근'],
    difficulty: 'beginner',
    equipment: ['맨몸', '벽 또는 소파'],
    purpose: 'stretch',
    phase: 1,
    patternIds: ['hip_flexor_restriction'],
    howTo: '뒷발 발등을 소파나 벽에 붙이고 앞무릎을 90도로 굽혀 런지 자세를 만듭니다. 골반을 앞으로 내밀며 허벅지 앞쪽과 사타구니 당김을 느낍니다. 40초 유지. 일반 힙플렉서 스트레칭보다 심부까지 해방됩니다.',
    prescription: { sets: 3, durationSec: 40, restSec: 20, eachSide: true, note: '허리가 꺾이지 않도록 복부 힘 유지 — 특히 제한 있는 쪽 집중' },
    demoSearchQuery: '코치 스트레칭 장요근 고관절 굴곡근',
  },
  high_knee_march: {
    id: 'high_knee_march',
    nameKr: '하이니 마치 (제자리 무릎 올리기)',
    nameEn: 'High Knee March',
    targetMuscles: ['장요근', '대퇴사두근', '복횡근', '둔근'],
    difficulty: 'beginner',
    equipment: ['맨몸'],
    purpose: 'activation',
    phase: 2,
    patternIds: ['hip_flexor_restriction', 'pelvic_asymmetry'],
    howTo: '제자리에서 한쪽씩 무릎을 골반 높이까지 의도적으로 들어올립니다. 양쪽 높이가 대칭이 되도록 의식하며 진행합니다. 올릴 때 지지하는 쪽 둔근도 동시에 수축합니다.',
    prescription: { sets: 3, reps: 20, restSec: 40, note: '좌우 높이 대칭을 거울이나 영상으로 확인하면 효과적' },
    demoSearchQuery: '하이니 마치 무릎 드라이브 교정 보행',
  },
  tibial_nerve_floss: {
    id: 'tibial_nerve_floss',
    nameKr: '경골 신경 플로싱',
    nameEn: 'Tibial Nerve Floss',
    targetMuscles: ['경골 신경', '종아리 후방 근막', '가자미근'],
    difficulty: 'beginner',
    equipment: ['맨몸'],
    purpose: 'mobility',
    phase: 1,
    patternIds: ['compensatory_calf_overload', 'ankle_restriction'],
    howTo: '의자에 앉아 발목을 발등 굽힘(배측굴곡)으로 올리며 무릎을 편다 → 발목을 내리며(족저굴곡) 무릎을 굽힌다. 천천히 교대로 15회. 저릿한 느낌이 나면 속도를 줄이세요.',
    prescription: { sets: 2, reps: 15, restSec: 20, eachSide: true, note: '신경 조직 긴장 해방 목적 — 통증이 심하면 범위 줄이기' },
    demoSearchQuery: '경골 신경 플로싱 종아리 저림 신경 운동',
  },
